...
export class UlpStat extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save UlpStat entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save UlpStat entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("UlpStat", id.toString(), this);
  }

  static load(id: string): UlpStat | null {
    return store.get("UlpStat", id) as UlpStat | null;
  }
  ...
  get ulpSupply(): BigInt {
    let value = this.get("ulpSupply");
    return value.toBigInt();
  }

  set ulpSupply(value: BigInt) {
    this.set("ulpSupply", Value.fromBigInt(value));
  }
  ...
  get distributedEsUnity(): BigInt {
    let value = this.get("distributedEsUnity");
    return value.toBigInt();
  }

  set distributedEsUnity(value: BigInt) {
    this.set("distributedEsUnity", Value.fromBigInt(value));
  }

  get distributedEsUnityCumulative(): BigInt {
    let value = this.get("distributedEsUnityCumulative");
    return value.toBigInt();
  }

  set distributedEsUnityCumulative(value: BigInt) {
    this.set("distributedEsUnityCumulative", Value.fromBigInt(value));
  }

  get distributedEsUnityUsd(): BigInt {
    let value = this.get("distributedEsUnityUsd");
    return value.toBigInt();
  }

  set distributedEsUnityUsd(value: BigInt) {
    this.set("distributedEsUnityUsd", Value.fromBigInt(value));
  }

  get distributedEsUnityUsdCumulative(): BigInt {
    let value = this.get("distributedEsUnityUsdCumulative");
    return value.toBigInt();
  }

  set distributedEsUnityUsdCumulative(value: BigInt) {
    this.set("distributedEsUnityUsdCumulative", Value.fromBigInt(value));
  }
...
export class UnityStat extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save UnityStat entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save UnityStat entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("UnityStat", id.toString(), this);
  }

  static load(id: string): UnityStat | null {
    return store.get("UnityStat", id) as UnityStat | null;
  }
