...
export class UlpManager extends ethereum.SmartContract {
  static bind(address: Address): UlpManager {
    return new UlpManager("UlpManager", address);
  }
  ...
  addLiquidity(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(_minUlp)
      ]
    );
  ...
  ulp(): Address {
    let result = super.call("ulp", "ulp():(address)", []);

    return result[0].toAddress();
  }

  try_ulp(): ethereum.CallResult<Address> {
    let result = super.tryCall("ulp", "ulp():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  removeLiquidity(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(_ulpAmount),
