...
export class Vault extends ethereum.SmartContract {
  ...
  getEntryFundingRate(
    ...
    let result = super.call(
      "getEntryFundingRate",
      "getEntryFundingRate(address,address,bool):(uint256)",
      [
        ethereum.Value.fromAddress(_collateralToken),
        ethereum.Value.fromAddress(_indexToken),
        ethereum.Value.fromBoolean(_isLong)
  ...
  getFundingFee(
    ...
    let result = super.call(
      "getFundingFee",
      "getFundingFee(address,address,address,bool,uint256,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(_account),
        ethereum.Value.fromAddress(_collateralToken),
        ethereum.Value.fromAddress(_indexToken),
  ...
  getPositionFee(
    ...
    let result = super.call(
      "getPositionFee",
      "getPositionFee(address,address,address,bool,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(_account),
        ethereum.Value.fromAddress(_collateralToken),
        ethereum.Value.fromAddress(_indexToken),
