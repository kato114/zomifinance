...
export function handleCancelIncreasePosition(event: positionRouter.CancelIncreasePosition): void {
  let id = _getIdFromEvent(event)
...
export function handleCancelDecreasePosition(event: positionRouter.CancelDecreasePosition): void {
  let id = _getIdFromEvent(event)
